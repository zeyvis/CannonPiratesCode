...
namespace DavidJalbert
{
    public class TinyCarCamera : MonoBehaviour
    {
        ...
        // --- YENÝ EKLENEN SINIRLANDIRMA (CLAMPING) DEÐÝÞKENLERÝ ---
        [Header("Camera Limits (Boundaries)")]
        [Tooltip("If true, the camera will not move past the defined Min/Max X and Z values.")]
        ...
        {
            EntryPanel.onPlay += SetTopView;
            EntryPanel.onShop += SetThirdPerson;
        }
